...
class UploadController( BaseUIController ):
        ...
        if kwd.get( 'upload_button', False ):
            ...
            if uploaded_file or uploaded_directory:
                ...
                if istar:
                    ...
                    #Create, went you update a xml in the tool_sheld, a pot file.
                    if ( full_path == '*.xml'):
                        self.create_pot_file ( full_path )
    ...
    def create_pot_file ( xml_full_path ):
        # for utf-8
        sys.setdefaultencoding("utf-8")

        # XML file name
        xml_file = xml_full_path
        print( "XML :" + xml_file )
